...
<div class="menu">
	...
	<a href="../" title="Gadgets"><img class="gadget menuS" src="img/gadget.png" alt="MenuGadget" 
	...
	<a href="../" title="Téléphones"><img class="phone menuS" src="img/phone.png" alt="MenuPhone" 
	...
	<a href="../PPE-GeekZone" title="Accueil"><img class="accueil menuS" src="img/accueilgeek.png" alt="MenuAccueil" 
