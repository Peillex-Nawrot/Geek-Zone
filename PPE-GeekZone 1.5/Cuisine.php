...
<body>
	...
	<div class="photoCadre">
		...
		<div class = "cuisine1">
			<a href="Cuisine1.php" title="Cuisine1"><img class = "imgCuisine1 articleS" src = "img/cuisine/fridgebook-magnet-reseau-social-frigo (1).jpg" /></a>
		</div>
		<div class = "cuisine2">
			<a href="Cuisine2.php" title="Cuisine2"><img class = "imgCuisine2 articleS" src = "img/cuisine/glacons-tetris (1).jpg" /></a>
		</div>
		<div class = "cuisine3">
			<a href="Cuisine3.php" title="Cuisine3"><img class = "imgCuisine3 articleS" src = "img/cuisine/mug-pac-man-chaud-froid.jpg" /></a>
		</div>
	</div>
