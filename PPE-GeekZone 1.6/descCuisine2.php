...
<body>
	...
	<div class="miniPhotoProduit1"> 	<!-- Petite photo n°1 -->
		<form id="f1" class="f1" method="post"  action="descCuisine2.php">
		<input class="descImg image1Cuisine2" name="b1" type="submit" value="" id="b1" />
		</form>
	</div>
	 
	<div class="miniPhotoProduit2"> 	<!-- Petite photo n°2 -->
		<form id="f1" class="f1" method="post"  action="descCuisine2.php">
		<input class="descImg image2Cuisine2" name="b2" type="submit" value="" id="b2" />
		</form>
	</div>
	
	<div class="miniPhotoProduit3"> 	<!-- Petite photo n°2 -->
		<form id="f1" class="f1" method="post"  action="descCuisine2.php">
		<input class="descImg image3Cuisine2" name="b3" type="submit" value="" id="b3" />
		</form>
	</div>
	...
	<?php
	if (isset($_POST['b1'])) {
		echo '<img class="descImgBase" src="img/Cuisine/glacons-tetris (1).jpg" />';
	} elseif (isset($_POST['b2'])) {
		echo '<img class="descImgBase" src="img/Cuisine/glacons-tetris (2).jpg" />';
	} elseif (isset($_POST['b3'])) {
		echo '<img class="descImgBase" src="img/Cuisine/glacons-tetris.jpg" />';
	} else {
		echo '<img class="descImgBase" src="img/Cuisine/glacons-tetris (1).jpg" />';
	}
		?>
