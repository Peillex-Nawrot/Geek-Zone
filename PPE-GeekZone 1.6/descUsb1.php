...
<body>
	...
	<div class="miniPhotoProduit1"> 	<!-- Petite photo n°1 -->
		<form id="f1" class="f1" method="post"  action="descUsb1.php">
		<input class="descImg image1Usb1" name="b1" type="submit" value="" id="b1" />
		</form>
	</div>
	 
	<div class="miniPhotoProduit2"> 	<!-- Petite photo n°2 -->
		<form id="f1" class="f1" method="post"  action="descUsb1.php">
		<input class="descImg image2Usb1" name="b2" type="submit" value="" id="b2" />
		</form>
	</div>
	...
	<?php
	if (isset($_POST['b1'])) {
		echo '<img class="descImgBase" src="img/USB/chauffe-tasse-biscuit-usb.jpg" />';
	} elseif (isset($_POST['b2'])) {
		echo '<img class="descImgBase" src="img/USB/chauffe-tasse-biscuit-usb-1.jpg" />';
	} else {
		echo '<img class="descImgBase" src="img/USB/chauffe-tasse-biscuit-usb.jpg" />';
	}
		?>
